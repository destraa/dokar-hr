    ...
    <header className="bg-slate-50/80 sticky top-0 z-50 backdrop-blur-md border-b border-slate-200">
      <div className="container mx-auto px-6 py-4 flex justify-between items-center">
        <div className="flex items-center space-x-2">
          ...
          <span className="text-2xl font-bold text-slate-800">Dokar HR</span>
        </div>
        <nav>
          <a
            href="#cta"
            className="hidden sm:inline-block bg-indigo-600 text-white font-medium px-5 py-2.5 rounded-lg hover:bg-indigo-700 transition-colors duration-300"
          >
            Minta Demo Gratis
          </a>
        </nav>
